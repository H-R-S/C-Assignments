/* Design a marks sheet for a student with 5 subjects includingMath, Physics, Electronics, 
Islamiat and Computer Programming.

Take marks as input from user calculate grade for each subject,CGPA and percentage.
