/* Write a C program to make a resume that takes input from the user and then displays the 
complete details. Resume should be formatted properly, using escape sequences */
#include <stdio.h> 
int main()
{
	// Declares variables
